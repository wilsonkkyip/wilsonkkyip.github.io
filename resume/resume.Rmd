...
export_fname: resume20240916.html
to_index: true
---
...
<table class="skills">
  <tr id="Data-Processing" class="h"></tr>
  <tr id="Python" class="icn s4" val="fa6-brands:python"></tr>
  <tr id="R" class="icn s4" val="fa6-brands:r-project"></tr>
  <tr id="Airflow" class="icn s4" val="devicon-plain:apacheairflow"></tr>
  <tr id="BigQuery" class="icn s4" val="simple-icons:googlebigquery"></tr>
  <tr id="DBT" class="icn s4" val="simple-icons:dbt"></tr>
...
<table class="skills">
  ...
  <tr id="GCP" class="icn s3" val="simple-icons:googlecloud"></tr>
</table>

<table class="skills">
  <tr id="Infrastructure-As-Code" class="h"></tr>
  <tr id="Docker" class="icn s3" val="fa-brands:docker"></tr>
  <tr id="Terraform" class="icn s3" val="simple-icons:terraform"></tr>
...
<table class="skills">
  ...
  <tr id="GitHub Actions" class="icn s3" val="simple-icons:githubactions"></tr>
  <tr id="Rust" class="icn s3" val="fa6-brands:rust"></tr>
  <tr id="Ruby" class="icn s3" val="devicon-plain:ruby"></tr>
  <tr id="Google-Script" class="icn s3" val="simple-icons:googleappsscript"></tr>
</table>
...
- Build and maintain **ELT** **data-pipelines** from different platforms (such 
  ...
  and **DBT**. 
  - Design abstract **dags** and **operators** to govern the general process of
    the ELT. 
  - Design abstract **HttpHook** to handle different http errors, especially
    setting up retry mechanism when **rate limit** is exceeded. 
  - Set up layers of tables and perform **feature engineering** to bring raw 
    data into meaningful fields. 
...
- Quality and cost control on data warehouse
  - Write generic tests on DBT daily to monitor data quality and byte 
    usage on BigQuery. 
  - Setup **CI jobs** on DBT before merging PRs to identify potential bugs. 
  - **Reduced 80% of the monthly bill from BigQuery** by optimising the queries, 
    model materialisation  and stroage billing model. 
- **Review pull request on GitHub** from data analyst. 

### [Tailify Software](https://www.linkedin.com/company/tailify)

[Machine Learning Engineer](https://www.linkedin.com/company/tailify)
